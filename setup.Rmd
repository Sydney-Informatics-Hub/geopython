...
* Download the python environment file for your system: [Windows](requirements/environment_win.yml), [MacOSX](requirements/environment.yml), [Linux](requirements/environment_linux.yml). This is a small text file, you may have to "Right Click > Save link as..." to download it.
