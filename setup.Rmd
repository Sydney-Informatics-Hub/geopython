...
to run a Python interpreter (type ```exit()``` to quit back to the terminal/prompt). We will be mostly using *Jupyter Notebooks* to interface with Python, so see the next section on how to launch a Notebook.
