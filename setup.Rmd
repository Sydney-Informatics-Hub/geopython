...
* Assuming you have downloaded the *environment.yml* file to your Downloads folder. Type in the below command at the prompt. This should take about 15 minutes to download (~1GB of data) and install the environment packages:
