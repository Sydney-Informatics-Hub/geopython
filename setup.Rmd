...
* Download the python environment file for your system: [Windows](requirements/environment_win.yml), [MacOSX](requirements/environment_osx.yml), [Linux](requirements/environment_linux.yml), or the [universal version](requirements/environment.yml). This is a small text file, you may have to "Right Click > Save link as..." to download it.
...
If you are working on a Mac with the `environment_osx.yml` file, the following is equivalent:

```sh
conda create -n geopy -file ~/Downloads/environment_osx.yml
```
...
[https://cloudstor.aarnet.edu.au/plus/s/91HrHFMl4zWANZ6/download](https://cloudstor.aarnet.edu.au/plus/s/91HrHFMl4zWANZ6/download)
