...
```sh
conda env create -n PESA -f C:\Users\nbutter\Downloads\environment.yml
```
...
[https://cloudstor.aarnet.edu.au/plus/s/I8e6FctLhDRtBhx/download](https://cloudstor.aarnet.edu.au/plus/s/I8e6FctLhDRtBhx/download)
...
If the above options do not work for you, you can use an on-demand cloud instance. You will be given a weblink. Done.
